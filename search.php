    ...
    <div class="contant_wrapper">
        ...
        <div id="right_contant1">
            ...
            <div id="product_box1">
                ...
                <?php
                global $con;
                $get_product = "SELECT product_price* FROM products WHERE  ORDER BY product_price DESC";
                $run_product = mysqli_query($con,$get_product);
                    ...
                    while ($row_products = mysqli_fetch_array($run_product)) {
                     ...
                     <a href='product.php?pro_id=$pro_id''><img src='../admin_area/product_images/$pro_image' width='180' height='180'></a>
                    <br/>
                    <p><b>price:$pro_price &#8377;</b></p>
                  
                    <center>
                    <a href='cart.php?add_cart=$pro_id'><button>Add to Cart</button></a></center>
